...
docker build -t $IMAGE_NAME -f "${HOME}/vscode_projects/VI-Stereo-DSO/Docker/Dockerfile" .
...
docker run \
    ...
    -v ${HOME}/vscode_projects/VI-Stereo-DSO:/root/${PROJECT_NAME} \
